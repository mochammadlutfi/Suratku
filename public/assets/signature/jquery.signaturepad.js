...
function SignaturePad (selector, options) {
  ...
  function onBeforeValidate (context, settings) {
    $('span.' + settings.errorClass, context).remove()
  ...
  function onFormError (errors, context, settings) {
    if (errors.nameInvalid) {
      context.prepend(['<span class="', settings.errorClass, '">', settings.errorMessage, '</span>'].join(''))
    ...
    if (errors.drawInvalid)
      context.prepend(['<span class="', settings.errorClass, '">', settings.errorMessageDraw, '</span>'].join(''))
  }
...
$.fn.signaturePad.defaults = {
  ...
  , bgColour : '#6660' // The colour fill for the background of the canvas; or transparent
  , penColour : '#2d2c2c' // Colour of the drawing ink
  ...
  , errorClass : 'text-danger' // The class applied to the new error Html element
  , errorMessage : 'Please enter your name' // The error message displayed on invalid submission
  , errorMessageDraw : 'Tanda Tangan Tidak Boleh Kosong' // The error message displayed when drawOnly and no signature is drawn
