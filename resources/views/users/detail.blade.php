        ...
        <div class="col-lg-12">
            <div class="block block-rounded block-transparent bg-gd-sea">
                <div class="block-content">
                    <div class="py-20 text-center">
                        ...
                        <h2 class="h4 font-w400 text-white-op">Detail Pengguna</h2>
                    </div>
                </div>
            </div>
            <!-- Default Elements -->
            <div class="block block-rounded">
                <div class="block-header">
                    <h3 class="block-title">Detail Pengguna</h3>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <span><strong>{{ $pengguna->nama }}</strong></span>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <span class="col-1"><strong>:</strong></span>
                                    <div class="col-6">
                                        <span><strong>{{ $pengguna->username }}</strong></span>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <span class="col-1"><strong>:</strong></span>
                                    <div class="col-6">
                                        <span><strong>{{ $pengguna->nik }}</strong></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <span class="col-1"><strong>:</strong></span>
                                    <div class="col-6">
                                        <span><strong>{{ $pengguna->email }}</strong></span>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <span class="col-1"><strong>:</strong></span>
                                    <div class="col-6">
                                        <span><strong>{{ $pengguna->no_hp }}</strong></span>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <span class="col-1"><strong>:</strong></span>
                                    <div class="col-6">
                                        <span><strong>{{ $pengguna->foto }}</strong></span>
                                    </div>
                                </div>
