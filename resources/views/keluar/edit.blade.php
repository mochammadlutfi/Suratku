    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    <form action="{{ route('surat.keluar.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <div class="form-group row {{ $errors->has('no_indeks') ? ' is-invalid' : '' }}">
                                    <div class="col-md-12">
                                        <div class="form-material form-material-primary ">
                                            <input type="text" class="form-control" id="no_indeks" name="no_indeks" placeholder="Masukan No Indeks" value="{{ $data->no_indeks }}">
                                ...
                                <div class="form-group row {{ $errors->has('no_surat') ? ' is-invalid' : '' }}">
                                    <div class="col-md-12">
                                        <div class="form-material form-material-primary ">
                                            <input type="text" class="form-control" id="no_surat" name="no_surat" placeholder="Masukan No Surat" value="{{ $data->nomor }}">
                                ...
                                <div class="form-group row {{ $errors->has('tgl_surat') ? ' is-invalid' : '' }}">
                                    <div class="col-md-12">
                                        <div class="form-material form-material-primary ">
                                            <input type="text" class="js-datepicker form-control" id="tgl_surat" name="tgl_surat" placeholder="Masukan Tanggal Surat" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" data-language="id" value="{{ date("d-m-Y", strtotime($data->tgl_surat)) }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-material form-material-primary ">
                                            <select class="form-control" name="pengolah" id="pengolah">
                                                ...
                                                <option value="{{ $d->id }}" {{ $d->id = $data->dari ? 'selected=selected' : null }}>{{ ucfirst($d->name) }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="form-group row {{ $errors->has('tujuan') ? ' is-invalid' : '' }}">
                                    <div class="col-md-12">
                                        <div class="form-material form-material-primary ">
                                            <input type="text" class="form-control" id="tujuan" name="tujuan" placeholder="Masukan Nama Atau Lembaga Perorangan" value="{{ $data->kepada }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row {{ $errors->has('perihal') ? ' is-invalid' : '' }}">
                                    <div class="col-md-12">
                                        <div class="form-material form-material-primary ">
                                            <input type="text" class="form-control" id="perihal" name="perihal" placeholder="Masukan Perihal Surat" value="{{ $data->perihal }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-material form-material-primary ">
                                            <select class="form-control" name="sifat" id="sifat">
                                                ...
                                                <option value="Amat Segera" {{ $data->sifat_surat === 'Amat Segera' ? 'selected=selected' : null }}>Amat Segera</option>
                                                <option value="Segera" {{ $data->sifat_surat === 'Segera' ? 'selected=selected' : null }}>Segera</option>
                                                <option value="Biasa" {{ $data->sifat_surat === 'Biasa' ? 'selected=selected' : null }}>Biasa</option>
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-material form-material-primary ">
                                            <select class="form-control" name="media" id="media">
                                                ...
                                                <option value="Hardcopy" {{ $data->media === 'Hardcopy' ? 'selected=selected' : null }}>Hardcopy</option>
                                                <option value="Softcopy" {{ $data->media === 'Softcopy' ? 'selected=selected' : null }}>Softcopy</option>
                                            </select>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="form-material form-material-primary ">
                                            <textarea class="form-control" name="keterangan" id="keterangan" placeholder="Masukan Keterangan Surat (Jika Ada)" rows="6">{{ $data->keterangan }}</textarea>
