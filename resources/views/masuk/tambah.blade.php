    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    <form action="{{ route('surat.masuk.tambah') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row {{ $errors->has('sumber') ? ' is-invalid' : '' }}">
                                    <div class="col-md-12">
                                        <div class="form-material form-material-primary ">
                                            <input type="text" class="form-control" id="sumber" name="sumber" placeholder="Masukan Sumber Surat">
