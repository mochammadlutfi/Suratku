                            ...
                            <div class="content content-full">
                                ...
                                <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <a class="link-effect text-muted mr-10 mb-5 d-inline-block float-right" href="op_auth_reminder2.html">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-sm btn-hero btn-alt-primary btn-block">
